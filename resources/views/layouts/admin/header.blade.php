                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ asset(Auth::guard('admins')->user()->avatar) }}" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text"><?php echo Auth::guard('admins')->user()->firstname . " " . Auth::guard('admins')->user()->lastname?> </span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo Auth::guard('admins')->user()->username ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
