...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admins | Velzon - Admin & Dashboard Template</title>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ asset($admin->avatar) }}" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">{{ $admin->firstname . " " . $admin->lastname }}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ $admin->username }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="col-lg-12">
                            <div class="card" id="customerList">
                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="d-flex flex-wrap align-items-start gap-2">
                                                ...
                                                <button type="button" class="btn btn-primary add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add Admin</button>
                                ...
                                <div class="card-body">
                                            ...
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light text-muted">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">Admin</th>
                                                        <th class="sort" data-sort="email">Email</th>
                                                        <th class="sort" data-sort="phone">Phone</th>
                                                        <th class="sort" data-sort="dob">Birthday</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="date">{{ $value->joining_date}}</td>
                                                        <td class="status">
                                                            @if ( $value->status == 0)
                                                        ...
                                                        @if( $adminType->admin_type == 0 )
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                                    <a href="#showModal" data-bs-toggle="modal" id="{{ $value->id }}" class="text-primary d-inline-block edit-item-btn">
                                                                        <i class="ri-pencil-fill fs-16"></i>
                                                                    </a>
                                                                </li>
                                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Remove">
                                                                    <a class="text-danger d-inline-block remove-item-btn" id="{{ $value->id }}" data-bs-toggle="modal" href="#deleteRecordModal">
                                    ...
                                    <form class="modal fade" id="showModal" tabindex="-1" aria-hidden="true" method="POST">
                                        @csrf
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header bg-light p-3">
                                                    <h5 class="modal-title" id="">Add Admin</h5>
                                                ...
                                                <div class="tablelist-form" autocomplete="off" >
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="firstname-field" class="form-control" name="firstname" placeholder="Enter first name" required />
                                                            <div class="invalid-feedback">Please enter a first name.</div>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="lastname-field" class="form-label">Last Name</label>
                                                            <input type="text" id="lastname-field" class="form-control" name="lastname" placeholder="Enter last name" required />
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="phone-field" class="form-control" name="phone" placeholder="Enter phone no." required />
                                                            <div class="invalid-feedback">Please enter a phone.</div>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="birthday-field" class="form-label">Birthday</label>
                                                            <input type="date" id="birthday-field" class="form-control" name="dob" data-provider="flatpickr" data-date-format="d M, Y" required placeholder="Select birthday" />
                                                            <div class="invalid-feedback">Please select a date.</div>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="gender-field" class="form-label">Gender</label>
                                                            <select id="gender-field" class="form-select" name="gender" required>
                                                        ...
                                                        <div>
                                                            ...
                                                            <select class="form-select" name="status" id="status-field"  required>
